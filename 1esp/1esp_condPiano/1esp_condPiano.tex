...
\makeatother
    ...
    \section{Descrizione dei sensori
utilizzati}\label{descrizione-dei-sensori-utilizzati}

    \subsection{sonda di tensione
(voltmetro)}\label{sonda-di-tensione-voltmetro}

\begin{itemize}
\item
  \textbf{identificatione del sensore} Experiment \textgreater{} Set Up
  Sensors \textgreater{} Show all interfaces (canale
  connsesso)\textgreater{} Choose sensor \textgreater{} Raw Voltage
  (scegliere precisione)
\item
  \textbf{Azzeramento} Experiment \textgreater{} Zero
\item
  \textbf{calibrazione} Experiment \textgreater{} Sensor info
  Calibration \textgreater{} keep
\end{itemize}

\subsection{sonda di corrente
(amperometro)}\label{sonda-di-corrente-amperometro}

\begin{longtable}[]{@{}lll@{}}
\toprule
corrente massima & precisione & resistore\tabularnewline
\midrule
\endhead
100 mA & 50 uA & 100 Ohm\tabularnewline
20 A & 10 mA & 0.5 Ohm\tabularnewline
\bottomrule
\end{longtable}
...
\tightlist
\item
  \textbf{aazzeramento} Experiment \textgreater{} zero
\item
  \textbf{misura di corrente} Data \textgreater{} New Calculated Column
  Equation \textless{} "Potential 1"/100 -\/-\textgreater{} Variables
  \textless{} Potential 1
\end{itemize}

\subsection{Sensore di carica}\label{sensore-di-carica}

\begin{longtable}[]{@{}llll@{}}
\toprule
Sensore & impedenza & Capazità & costante di tempo\tabularnewline
\midrule
\endhead
Vernier CRG-BTA & \textgreater{}1 MOhm & 10 nF & 0.1 s\tabularnewline
\bottomrule
\end{longtable}

\begin{longtable}[]{@{}ll@{}}
\toprule
Potenziale di Fondo scala {[}V{]} & carica {[}nC{]}\tabularnewline
\midrule
\endhead
0.5 & 5\tabularnewline
2 & 20\tabularnewline
...
\textbf{NB} errore sistematico : la misura corretta sarebbe
\[ Q = (C0+C)V \]

\subsection{Sensore di campo
magnetico}\label{sensore-di-campo-magnetico}

Vernier MG-BTA (Sonda Hall)

\begin{longtable}[]{@{}ll@{}}
\toprule
Fondo scala & precisione\tabularnewline
\midrule
\endhead
0.3 mT & 0.2 uT\tabularnewline
6.4 mT & 4 uT\tabularnewline
\bottomrule
\end{longtable}

    \section{capacità del condensatore
piano}\label{capacituxe0-del-condensatore-piano}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}23}]:}         d   d-d0  fondo  giri      q  segnale
...
\end{Verbatim}
 ...
 $ Q(d) = \epsilon\_0 \frac{ A}{ d+d_0} V + B $
...
{\color{incolor}In [{\color{incolor}24}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{spos}\PY{p}{,} \PY{n}{q}\PY{p}{,} \PY{n}{marker} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{} print(\PYZsq{}eo, do, B\PYZsq{},popt)}
         \PY{c+c1}{\PYZsh{} print(\PYZsq{}covariance\PYZsq{},pcov)}
\end{Verbatim}
    ...
    \subsection{stima in}\label{stima-in}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} informazioni sul sistema utilizzato}
\end{Verbatim}
