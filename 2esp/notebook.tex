...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{schio\_demarchi\_esperienza2}
...
\makeatother
    ...
    \section{Volt-Amerometrica (II turno)}\label{volt-amerometrica-ii-turno}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{o}{\PYZpc{}}\PY{k}{load\PYZus{}ext} version\PYZus{}information
